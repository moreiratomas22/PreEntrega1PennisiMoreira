    ...
    return (
        <>
                    <form className='flex flex-col w-80 m-auto'>
                        ...
                        <input autoComplete="off" onChange={handleChangeEmail} className={emailConfirmation ? '' : 'text-red-400'} type="email" id="email2" />
                    <CustomButton handleButton={handleCompletePurchase} pmt="Terminar compra" disabled={!user.name || !user.tel || !user.email} />
                    </form>
